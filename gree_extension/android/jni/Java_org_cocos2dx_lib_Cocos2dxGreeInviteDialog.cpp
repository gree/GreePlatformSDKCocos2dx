		...
		if(JniHelper::getMethodInfo(t, "java/util/TreeMap", "<init>", "()V")){
			...
			if(GreeJniHelper::getInstanceMethodInfo(m, map, "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;")){
				...
				CCDICT_FOREACH(params, pElement){
					...
					if(!strncmp(GD_INVITE_DIALOG_PARAM_KEY_TOUSERID, pStr, sizeof(GD_INVITE_DIALOG_PARAM_KEY_TOUSERID))){
						//touserid
					...
					}else if(!strncmp(GD_INVITE_DIALOG_PARAM_KEY_BODY, pStr, sizeof(GD_INVITE_DIALOG_PARAM_KEY_BODY))){
						//body
