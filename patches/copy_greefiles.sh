...
HELLOWORLD_ROOT=$COCOS2DX_ROOT/../patches/HelloGreeCpp
...
copy_cpp_h(){
    ...
    for file in $COCOS2DX_ROOT/../patches/HelloGreeCpp/Classes/*
    do
...
copy_src_and_jni(){
    ...
    # replace Android.mk
    sh $COCOS2DX_ROOT/../patches/gamemk.sh $APP_DIR/proj.android/jni/Android.mk $NEED_BOX2D $NEED_CHIPMUNK $NEED_LUA
}
...
modify_androidmanifest(){
    sed "s/HelloCpp/$APP_NAME/;s/org\.cocos2dx\.hellogreecpp/$PACKAGE_PATH/" $HELLOWORLD_ROOT/proj.android/AndroidManifest.xml > $APP_DIR/proj.android/AndroidManifest.xml
}
...
modify_applicationdemo(){
    ...
    sed "s/HelloGreeCpp/$APP_NAME/;s/org\.cocos2dx\.hellogreecpp/$PACKAGE_PATH/;s/hellogreecpp/game/" $APP_DIR/proj.android/src/org/cocos2dx/hellogreecpp/HelloGreeCpp.java > $APP_DIR/proj.android/src/$PACKAGE_PATH_DIR/$APP_NAME.java    
    sed "s/HelloGreeCpp/$APP_NAME/;s/org\.cocos2dx\.hellogreecpp/$PACKAGE_PATH/;s/hellogreecpp/game/" $APP_DIR/proj.android/src/org/cocos2dx/hellogreecpp/HelloGreeCppApplication.java > $APP_DIR/proj.android/src/$PACKAGE_PATH_DIR/${APP_NAME}Application.java    
    rm -fr $APP_DIR/proj.android/src/org/cocos2dx/hellogreecpp
}
...
copy_xml(){
	cp -r $HELLOWORLD_ROOT/proj.android/res/xml $APP_DIR/proj.android/res/
}
