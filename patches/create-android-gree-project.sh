...
#NDK_ROOT_LOCAL="/home/kazuma-morimoto/work/Tools/android-ndk-r8b/"
#ANDROID_SDK_ROOT_LOCAL="/home/kazuma-morimoto/work/Tools/android-sdk-linux/"
NDK_ROOT_LOCAL="/work/Tools/android-ndk-r8b/"
ANDROID_SDK_ROOT_LOCAL="/k/Tools/android-sdk-linux/"
...
if [ $0 = "linux" ]; then
    ...
    sh `pwd`/../patches/copy_greefiles.sh `pwd` $PROJECT_NAME $NDK_ROOT_LOCAL $PACKAGE_PATH $NEED_BOX2D $NEED_CHIPMUNK $NEED_LUA
fi
